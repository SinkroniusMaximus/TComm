...
// public:
//     WifiSocket() : client(nullptr) {}

//     bool Connect(const char* ssid, const char* password, const char* host, uint16_t port) {
...
//             size_t writtenBytes = client->write(buf, size);
//             PRINT((String)writtenBytes);
//             return writtenBytes;
//         }
//         return 0;
//     }
